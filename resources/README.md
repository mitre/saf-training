...
The RHEL8 Baseline Stubs were `saf-cli generate` command as documented in [Section 10](/courses/beginner/10.md) . You can use this as a reference while you develop your controls.
