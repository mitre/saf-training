<template><h2 id="generating-inspec-results" tabindex="-1"><a class="header-anchor" href="#generating-inspec-results" aria-hidden="true">#</a> Generating InSpec Results</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="syntax" tabindex="-1"><a class="header-anchor" href="#syntax" aria-hidden="true">#</a> Syntax</h3>
