<template><h2 id="_5-writting-the-inspec-controls" tabindex="-1"><a class="header-anchor" href="#_5-writting-the-inspec-controls" aria-hidden="true">#</a> 5. Writting the InSpec Controls</h2>
...
<h2 id="_5-1-refactoring-the-code-to-use-inputs" tabindex="-1"><a class="header-anchor" href="#_5-1-refactoring-the-code-to-use-inputs" aria-hidden="true">#</a> 5.1. Refactoring the code to use Inputs</h2>
...
<div class="language-ruby ext-rb line-numbers-mode"><pre v-pre class="language-ruby"><code>control <span class="token string-literal"><span class="token string">'nginx-modules'</span></span> <span class="token keyword">do</span>
  ...
  <span class="token keyword">end</span>
<span class="token keyword">end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-2-multiple-inputs-example" tabindex="-1"><a class="header-anchor" href="#_5-2-multiple-inputs-example" aria-hidden="true">#</a> 5.2. Multiple Inputs Example</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_5-3-running-the-baseline-straight-from-github" tabindex="-1"><a class="header-anchor" href="#_5-3-running-the-baseline-straight-from-github" aria-hidden="true">#</a> 5.3. Running the baseline straight from Github</h2>
