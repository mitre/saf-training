...
== Expected Output - .github folder structure
...
::: info Saving Files vs. Pushing Code
...
== `pipeline.yml` after adding a job
...
== `pipeline.yml` after adding a step
