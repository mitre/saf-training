...
Most of this section is informed by DISA's own published guidance for the Vendor STIG Process, as well as the experiences of external teams and Vulcan(tm) stakeholders who have undergone the STIG creation process.
...
::: info Do I need to be the actual vendor to publish my content?
...
[^VendorSTIGProcessGuide]: See [Resources](../../resources/index.md) for each topic in this section.