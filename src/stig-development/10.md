...
Let's use the RHEL9 STIG -- the _real_ RHEL9 STIG -- as an example. The RHEL9 STIG document is conveniently loaded into the training instance of Vulcan(tm) for us to examine. Check out the STIG option on the top navbar.
...
::: info Wait, why does the real STIG use different IDs for each requirement?
...
::: info So how do I know which requirements are appropriate to combine or split apart?
