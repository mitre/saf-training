...
Luckily, Vulcan(tm) has access to every STIG and SRG you have uploaded to the instance for cross-referencing.
...
[^VendorSTIGProcessGuide]: Sections 4.1.11 and 4.1.13 of the "Vendor STIG Process", Version 4 Release 1. See [Resources](../../resources/index.md).