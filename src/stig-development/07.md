...
Click the "Edit Component Controls" button at the top of your Vulcan(tm) window on the left hand side.

![Edit Component Controls Button](/assets/img/edit_controls.png)

::: info Controls vs. Requirements
...
[^VendorSTIGProcessGuide]: Sections 4.1.15 through 4.1.17 of the "Vendor STIG Process", Version 4 Release 1. See [Resources](../../resources/index.md).