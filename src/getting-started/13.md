...
1. Find the profile to run - reference the [SAF(tm) validate page](https://saf.mitre.org/#/validate)
...
6. Add your results to your uploads in Heimdall(tm). Toggle off comparison view and select the RedHat8 in the top left menu.
