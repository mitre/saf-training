...
What about controls that cannot be automated and require manual review? You may have noticed that Heimdall(tm) displays controls in 4 statuses: `Passed`, `Failed`, `Not Applicable`, and `Not Reviewed`.
...
## 12.3 Manual Attestations Using SAF(tm) CLI
