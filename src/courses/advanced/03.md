...
```sh
inspec exec my_nginx_answer_key/ -t docker://nginx --input-file my_nginx_answer_key/inputs.yml--enhanced-outcomes
```
...
Version:   0.1.0
Target:    docker://0de4ce8ac0efbae74457a425ff50a030f2b74c87c19fb2996c673ef3358b415c
...
```sh
inspec exec my_nginx_answer_key/ -t docker://nginx --input-file my_nginx_answer_key/inputs.yml --reporter cli json:results/my_nginx_results.json --enhanced-outcomes
```
