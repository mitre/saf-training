...
From here, we can download that file and drop it off in something like Heimdall or feed into some other security process at our leisure (or we can add a pipeline step to do that for us!).
