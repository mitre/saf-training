...
We're focused on InSpec right now, so we won't correct this issue right now, but later you can check out the Chef [Secure your Infrastructure](https://learn.chef.io/tracks/integrated-compliance#/) tutorial course to learn more about how to correct compliance failures using Chef.
