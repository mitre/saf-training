...
Now that you've familiarized yourself with the formal OHDF schema, let's revisit the GoSec and Twistlock examples and apply some of that knowledge. 
...
- Which fields in the source data are used to fill each OHDF field? Is that mapping accurate?
  - Can you think of a reason for why that field is used to generate the OHDF field?
...
More examples of actual OHDF samples used in production can be [found here](https://github.com/mitre/heimdall2/tree/master/libs/hdf-converters/sample_jsons).
