...
order: 11
next: 12.md
title: Mapper Creation 5
author: Charles Hu
---

### \*-to-HDF Mapper Construction Example <a name="example2"></a>

The following is an example of a implemented HDF mapper for Twistlock created using a <b>[high-level Twistlock-to-HDF mapping](#example)</b> and <b>[tools from <i>base-converter</i>](#base)</b>.
