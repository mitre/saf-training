...
This walkthrough is targeted at converting security scans to OHDF. If your security tool provides exports that are not security scans or are APIs, contact the SAF(tm) team for further instruction on how to develop those services into an OHDF mapper.
:::
