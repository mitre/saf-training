...
Now that you have learned about making and running InSpec profiles as well as automating security validation through pipelines, let's dig deeper into the mechanics of InSpec by learning about InSpec resources.

As you saw in the beginner class, when writing InSpec code, many resources are available to you.
