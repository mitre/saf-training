...
Now let's write some controls and test that they run. You can put these controls in the `example.rb` file generated in the `controls` folder of your `git` profile.
```ruby
# encoding: utf-8
