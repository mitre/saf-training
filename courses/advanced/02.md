...
::: tip Reference
InSpec uses resources like the `file` resource to aid in control development. These resources can often be used as the `<entity>` in the describe block, where the expectation is checking a requirement of that entity. Find a list of resources in the [InSpec documentation ](https://docs.chef.io/inspec/)
:::
...
This example shows default metadata of the InSpec profile along with two optional sections. Let's break down each component.

::: tip
`version` (line 8) is the version of that inspec profile. [section 8 ](../beginner/05.md)
:::
