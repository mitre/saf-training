...
In the [first class](https://mitre-saf-training.netlify.app/course/02.html), we explained the structure and output of InSpec Profiles. Let's review some content, then practice by revisiting, running, and viewing results of an InSpec profile.
