...
In the [beginner class](/courses/beginner/06.md), we mentioned that you can specify an InSpec reporter to indicate the format in which you desire the results. 
