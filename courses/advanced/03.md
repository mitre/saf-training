...
In the [first course](https://mitre.github.io/saf-training/course/05.html), we wrote, ran, and analyzed results of an InSpec profile made up of controls. Let's recap this process with some practice.
...
In the [first class](https://mitre-saf-training.netlify.app/course/06.html), we mentioned that you can specify an InSpec reporter to indicate the format in which you desire the results. 
