...
::: tip New file alert
Did you notice a new file in the `Review` section above?
:::: details Answer
The inputs.yml now contains a new value `root` assigned to `admin_users` input.
:::
...
![Alt text](../../assets/img/NGINX_Heimdall_Report_View.png)
