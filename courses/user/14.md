---
index: 14
title: 14. Running InSpec with a Local Profile
author: Mo
headerDepth: 3
---
## 14. Example running an InSpec profile using a local archive (for air-gapped target systems)
