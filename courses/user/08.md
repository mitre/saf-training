...
index: 8
icon: page
title: 8. Running InSpec - Local Example
author: Aaron Lippold
headerDepth: 3
---

## 8. Example running an InSpec profile using a local archive (for air-gapped target systems)
