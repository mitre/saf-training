...
Let's take a look at what one of the `stub` InSpec control created by the `saf generate xccdf_benchmark2inspec_stub` command and the completed InSpec control.
