...
### 7.3.1 Our First Control Status
...
If we select any of those statuses in Vulcan, we therefore get a different set of fields to complete. We can't describe them better than DISA can, so we will refer you to the Vendor STIG guide for the definitions of the new fields.
...
[^VendorSTIGProcessGuide]: Section 4.1.17 of the "Vendor STIG Process", Version 4 Release 1. See Resources.